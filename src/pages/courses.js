...
const DataSQRLCourseBenefits = [
  ...
  },
  {
    ...
    description: (
      <>
        Our instructors are industry experts with decades of experience in designing, building, and
        managing streaming data products. And they love sharing their knowledge.
      </>
    ),
  },
  {
              ...
              <div className="col col--12">
                ...
                <table style={{width: 100 + "%" }}>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul>
                        <li>Tue, <strong>November 28</strong>, 2023</li>
                        <li>Thu, <strong>December 14</strong>, 2023</li>
                      </ul>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul>
                        <li>Tue, <strong>November 14</strong>, 2023</li>
                        <li>Thu, <strong>December 7</strong>, 2023</li>
                      </ul>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul>
                        <li>Thu, <strong>November 16</strong>, 2023</li>
                        <li>Tue, <strong>December 5</strong>, 2023</li>
                      </ul>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul>
                        <li>Thu, <strong>November 30</strong>, 2023</li>
                        <li>Tue, <strong>December 12</strong>, 2023</li>
                      </ul>
                    </td>
