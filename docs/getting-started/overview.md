...
If you're looking to learn DataSQRL, the best way is to build something with it. Just get started, and build something you enjoy.

<img src="/img/getting-started/tutorial/nutshop.jpg" alt="Nut Shop Tutorial >|" width="40%"/>

**STEP 1:** Follow the [Quickstart Tutorial](quickstart) to build a data service for our seed shop in 5 minutes. The tutorial walks you through an example and builds a whole data pipeline.

**STEP 2:** Dive into the [DataSQRL introduction](./intro/overview) to get a deeper understanding of DataSQRL and all the knowledge you need to build your own custom data service in DataSQRL. The introduction extends the quickstart and explains all the concepts in more detail.
