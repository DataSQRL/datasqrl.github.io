...
[DataSQRL](/docs/getting-started/concepts/datasqrl) simplifies the technology for building data products. To address the other two problem areas that frequently strike data product implementations, we developed the **DataSQRL Process**.
