...
Take a look at the [DataSQRL tutorial](https://www.datasqrl.com/docs/getting-started/quickstart/) to learn more about DataSQRL and [join us on Slack](/community) if you need any help. If you're looking to empower your team to build event-driven microservices like the pros, [we're here to help](https://www.datasqrl.com/services/) you hit the ground running.
